    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li> Place the cut fruits in the blender.</li>
          <li> Add milk to the blender as needed.</li>
          <li> Add ice if required.</li>
          <li> Start up the blender and blend until it is a liquid.</li>
          <li> Serve and enjoy!</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <br />
        Please
        <a href="https://www.github.com/vaarunx" id="wd-github">
           click here  
        </a>
